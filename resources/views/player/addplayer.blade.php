        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('createplayer') }}">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="inputPostPlayer" name="postplayer" class="form-control">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <a href="{{ route ('afficheplayer')}}" class="btn btn-secondary">Cancel</a>
                            <input type="submit" value="Create new player" class="btn btn-success float-right">
                        </div>
                    </div>
                </form>
            </div>
